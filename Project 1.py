...
def write_into_csv(info_list):
    with open('student_info.csv','w+',newline=' ')as csv_file:
        ...
        if csv_file.tell()==0:
            writer.writerow("Name","Age","Contact","EmailId")
...
if __name__=='__main__':
    ...
    while(condition):
        student_info=input("Enter student information for student #{} in the following format (Name Age Contact Email_id: ")
        print("Entered information: "+student_info)

    #split
    student_info_list=student_info.split(' ')
    print("Enterd split ip information list: "+str(student_info_list));
